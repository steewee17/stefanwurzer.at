$f = "ki-mitarbeiter\case-premium-leads\index.html"
...
$c = $c -replace '<meta name="description" content=".*">', '<meta name="description" content="Case Study: Wie die METEK GmbH durch multimodale KI-Analyse (Semantik & visuelle Ästhetik) exklusive Architektur-Leads für den Premium-Innenausbau identifiziert.">'
$c = $c -replace '<meta name="keywords" content=".*">', '<meta name="keywords" content="Case Study, B2B Vertrieb, Lead Pipeline, Lead Engine, Luxussegment, Architektur, KI-Analyse, METEK GmbH">'
...
$c = $c -replace '<meta property="og:title" content=".*">', '<meta property="og:title" content="Case Study: KI-Qualifizierung im Premium-Segment">'
$c = $c -replace '<meta property="og:description" content=".*">', '<meta property="og:description" content="Wie eine KI architektonische Ästhetik und semantische Fachartikel bewertet, um exklusive B2B-Kunden zu identifizieren.">'
...
$c = $c -replace 'Vertriebler sollen verkaufen. <br>Nicht kopieren.', 'Das Problem: <br>Subjektive Qualität.'
$c = $c -replace 'Gegenüberstellung im B2B-Vertrieb:', 'Herkömmliche Lead-Datenbanken liefern nur Standard-Metriken (Umsatz, Mitarbeiter). Sie verraten aber nicht, ob ein Architekturbüro "Premium" baut.'
$c = $c -replace '<div class="font-size:12px;font-weight:600;color:var\(--muted\);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:4px;">Manueller Blindflug</div>', '<div style="font-size:12px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:4px;">Die manuelle Lösung</div>'
...
$c = $c -replace '<div class="font-size:12px;font-weight:600;color:var\(--gold\);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:4px;">Die B2B-Lead-Pipeline</div>', '<div style="font-size:12px;font-weight:600;color:var(--gold);text-transform:uppercase;letter-spacing:0.1em;margin-bottom:4px;">Die KI-Lösung</div>'
...
# Steps Section
$c = $c -replace 'So funktioniert der <br><em>Prozess.</em>', 'Der 3-Säulen-<br><em>Algorithmus.</em>'
...
# We need to remove step 4 and step 5 to keep it to the 3 pillars, or repurpose them.
# Let's repurpose Step 4 for "LeadScore (1-10)" and Step 5 for "CRM Übergabe".
...
# Outcome Section
$c = $c -replace 'Dynamisches <em>Zielbild.</em>', 'Das <em>Ergebnis.</em>'
